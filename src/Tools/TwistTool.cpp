...
void TwistTool::Attach() {
    ...
    // Match the TwistedModel's transform and pass the size of the Model for
...
void TwistTool::PlaneClicked_(int dim) {
    const auto &context = GetContext();

    // Get the twist plane in stage coordinates based on axis-alignment.
    ...
    // Add and execute a ChangeTwistCommand.
    auto command = CreateCommand<ChangeTwistCommand>();
