...
const float    kFocusedPaneBorderWidth           = 4;
...
const float    kExtrudedModelHeight              = 2;
const float    kExtrudedModelRadius              = .4f;
const float    kExtrudedModelXZScale             = 4;
...
const float    kShelfIconMargin                  = .8f;
const float    kShelfIconSize                    = 3.2f;
...
const float    kMinGripControllerDistance        = .02f;
const float    kMinTouchControllerDistance       = .01f;
const float    kMinTouchZMotion                  = .02f;
const float    kProfilePanePointTolerance        = .04f;
const Anglef   kProfilePaneMaxSnapAngle          = Anglef::FromDegrees(10);
