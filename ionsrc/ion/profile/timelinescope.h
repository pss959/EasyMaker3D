...
#ifndef ION_PROFILE_TIMELINESCOPE_H_
#define ION_PROFILE_TIMELINESCOPE_H_
...
class TimelineScope : public TimelineEvent {
 public:
  ...
  Type GetType() const override { return Type::kScope; }
};

#endif  // ION_PROFILE_TIMELINESCOPE_H_
